    ...
    def _default_specs(self):
        ...
        placement = [
            ...
            i3.ConnectManhattan(
                ...
                # control_points=[
                #                     # i3.H(50, flexible=True),
                #                     # i3.V(80, flexible=True),
                #                     i3.V(120.0, flexible=True)
                #                     # i3.V(250, flexible=True),
                #                     # i3.H(250, flexible=True),
                # ],
...
if __name__ == "__main__":
    ...
    el_michelson = Michelson(bend_radius=5.0, fgc_dc_spacing=25.0, delay_length=200.0, fgc_spacing_y=127.0)
